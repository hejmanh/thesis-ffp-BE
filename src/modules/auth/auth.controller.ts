...
import type { RegisterResponseDto, VerifyEmailResponseDto, RefreshResponseDto, LogoutResponseDto } from './dto/response.dto.js';
...
export const registerHandler = asyncHandler(async (req: Request, res: Response<RegisterResponseDto>) => {
...
export const verifyEmailHandler = asyncHandler(async (req: Request, res: Response<VerifyEmailResponseDto>) => {
...
export const refreshHandler = asyncHandler(async (req: Request, res: Response<RefreshResponseDto>) => {
...
export const logoutHandler = asyncHandler(async (req: Request, res: Response<LogoutResponseDto>) => {
    const rawToken = req.cookies?.refreshToken;
    if (!rawToken) throw unauthorized('Missing refresh token');
